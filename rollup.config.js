...
) || warningIsIgnored(warning) || console.warn(warning.toString());
        ...
        () => {
          ...
          const buildGlobalCSS = () => {
            ...
            try {
              builder = spawn(
                'node',
                ['--experimental-modules', '--unhandled-rejections=strict', 'build-global-css.mjs', sourcemap],
              );
              ...
              builder.on('close', (code) => {
                if (code === 0) {
                  ...
                  console.log(`${colors.bold().green('✔ global css')} (src/global.pcss → static/global.css${sourcemap
                                                                                                            === true
